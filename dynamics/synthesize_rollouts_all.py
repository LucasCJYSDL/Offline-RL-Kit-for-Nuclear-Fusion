...
if __name__ == "__main__":
    ...
    # Tracking lists remain user-selectable
    ...
    tracking_val_data_path = os.path.join(synthesized_data_dir, "tracking_val.h5")
    tracking_test_data_path = os.path.join(synthesized_data_dir, "tracking_test.h5")
    ...
    if set(tracking_val_shot_list) & set(tracking_test_shot_list):

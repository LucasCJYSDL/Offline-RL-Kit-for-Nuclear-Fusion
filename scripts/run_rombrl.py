...
def get_args():
    ...
    apply_benchmark_defaults(parser, "rombrl", default_task="rotation")
...
def train(args=None):
    ...
    log_dirs = make_log_dirs_new(args.task, args.algo_name, args.seed, vars(args), record_params=["grad_mode", "sl_weight", "actor_training_epoch", "onpolicy_rollout_batch_size", "onpolicy_rollout_length", "small_traj_batch"], base_dir=args.base_dir)

...
def get_args():
    ...
    apply_benchmark_defaults(parser, "mppi", default_task="rotation")
...
def train(args=None):
    ...
    offline_data, _, env, _ = get_rl_data_envs(args.env, args.task, args.device,is_val=True)
